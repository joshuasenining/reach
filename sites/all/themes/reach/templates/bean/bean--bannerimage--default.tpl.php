...
$banneruri = isset($content['field_banner_image'][0]['#item']['uri']) ?  $content['field_banner_image'][0]['#item']['uri']: NULL;
$bannerurl = file_create_url($banneruri);
$subtitle = isset($content['field_banner_subtitle'][0]['#markup']) ?  $content['field_banner_subtitle'][0]['#markup']: NULL;
//$subtitle = $content['field_banner_subtitle'][0]['#markup']
?>
