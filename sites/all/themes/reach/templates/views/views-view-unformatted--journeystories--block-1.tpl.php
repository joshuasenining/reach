...
$link = isset($row->field_field_sidebar_link[0]['raw']['value']) ? $row->field_field_sidebar_link[0]['raw']['value'] : NULL;
...
<!--  <div class="col xl12 l12 m12 s12">
 ...
 <div class="col xl12 l12 m12 s12">
  <div class="valign-wrapper">
          ...
          <div class="card-content">
                                     <a href="<?php print $link;?>" target="_blank"><h6 class="name"><?php print $title;?></h6>
                                 </a>
                                     <p><?php print $body;?></p>
                                </div>
      </div>
