...
<?php if ($search_results): ?>
  <ul class="mck-search-results mck-search-results--border">
    <?php print render($search_results); ?>
 </ul>
  <?php print render($pager); ?>
<?php else : ?>
  <h5><?php print t('Your search yielded no results');?></h5>
  <p>&nbsp;</p>
  <p class="small mck-bp-hide-medium-low-and-lower">- Check if your spelling is correct.</p>
  <p class="small mck-bp-hide-medium-low-and-lower">- Use fewer keywords to increase the number of results.</p>
