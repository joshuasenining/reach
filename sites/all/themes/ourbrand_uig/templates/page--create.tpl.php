...
<div class="<?php print $wrapper_class; ?>">
  ...
  <div class="mck-th-turquoise heading inner-sub-header">
            <div class="inner-sub-icon"><span class="mck-icon__pencil"></span></div>
            <div class="inner-sub-nav"><h1>Create</h1> 
          <ul><li><a href="#">Literature &amp; Reports</a></li>
                  <li><a href="#">Presentations</a></li>
                <li><a href="#">Signage &amp; Stationery</a></li>
                <li><a href="#"> Apps</a></li>
                 <li><a href="#"> Events &amp; Initiatives</a></li>
                 <li><a href="#"> Microsites</a></li>
                 <li><a href="#"> Graphic Themes</a></li>
...
<!-- footer -->
<div class="mck-footer footer-section" role="footer">
