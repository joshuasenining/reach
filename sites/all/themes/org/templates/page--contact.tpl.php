      ...
      <div class="container no-l-pad">
        ...
        <!-- Left section --> 
          <div class="breadcrumb">
            <a href="<?php echo $base_url; ?>">Home</a>  »   <span class="orange-text bold-font">Contact Us</span>
          </div>

          

              <h2 class="title" id="page-title">Contact Us</h2>
              
              <?php 
                print("<span class='grey-text large-font'>Please fill out the form below.</span>");
