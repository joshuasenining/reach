                  ...
                  <div class="f-length">
                      ...
                      <div class="f-left fifteen"> 
                        ...
                        <ul class="stats vertical">
                          ...
                          <li><a href="#"><img src="<?php echo $theme_url; ?>/images/clock_orange.png"/>03:15</a></li>
                        </ul>
                      </div>

                      <div class="f-right eighty"> 

                           <h4 class="bold-weight">Global Business Services Forum #10</h4>
                           <p class="padding-bottom">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nec pharetra mi. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae. Quisque nec pharetra mi. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae.
                          </p>

                          <div class="f-length">
                              <div class="f-left eighty-five"> 
                                  <span class="category">Tags: </span> <a  class="category" href="#">Organizational Design</a>
                              </div>
                              <div class="f-right fifteen right-aligned"> <img src="<?php echo $theme_url; ?>/images/comment_gray.png"/>&nbsp;4</div>
                              <div class="c"></div>
                          </div>
                  ...
                  <div class="f-length">
                      ...
                      <div class="f-right eighty"> 
                          ...
                          <div class="f-length">
                              ...
                              <div class="f-right fifteen right-aligned"> <img src="<?php echo $theme_url; ?>/images/comment_gray.png"/>&nbsp;3</div>
                              <div class="c"></div>
                          </div>
                ...
                <div class="col-xs-12 list-view">
                  ...
                  <div class="f-length">
                      ...
                      <div class="f-left fifteen"> 
                        <img class="col-xs-12 video-frame" src="<?php echo $theme_url; ?>/images/video4.png"/>
                        <ul class="stats vertical">
                            <li><img src="<?php echo $theme_url; ?>/images/check_gray.png"/>23</li>
                            <li><img src="<?php echo $theme_url; ?>/images/clock_orange.png"/>08:45</li>
                        </ul>
                      </div>
                      ...
                      <div class="f-right eighty"> 
                          ...
                          <div class="f-length">
                              ...
                              <div class="f-right fifteen right-aligned"> <img src="<?php echo $theme_url; ?>/images/comment_gray.png"/>&nbsp;2</div>
                              <div class="c"></div>
                          </div>
